...
class Invoice {
  ...
  XmlDocument toXml() {
    ...
    List<XmlNode?> c2 = [
      ...
      ...despatchDocumentReference.map((DespatchDocumentReference e) => e.toXml()),
      ...receiptDocumentReference.map((ReceiptDocumentReference e) => e.toXml()),
      ...statementDocumentReference.map((StatementDocumentReference e) => e.toXml()),
      ...originatorDocumentReference.map((OriginatorDocumentReference e) => e.toXml()),
      ...
      ...projectReference.map((ProjectReference e) => e.toXml()),
      ...
      ...prepaidPayment.map((PrepaidPayment e) => e.toXml()),
