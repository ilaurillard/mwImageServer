...
class ShipSanitationControlExemptionDocumentReference {
  ...
  static ShipSanitationControlExemptionDocumentReference? fromJson(Map<String, dynamic>? json) {
    if (json == null) { return null; }
    return ShipSanitationControlExemptionDocumentReference (
  ...
  static ShipSanitationControlExemptionDocumentReference? fromXml(XmlElement? xml) {
