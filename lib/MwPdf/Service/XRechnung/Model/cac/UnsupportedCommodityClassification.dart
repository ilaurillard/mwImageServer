...
class UnsupportedCommodityClassification {
  ...
  static UnsupportedCommodityClassification? fromJson(Map<String, dynamic>? json) {
  ...
  static UnsupportedCommodityClassification? fromXml(XmlElement? xml) {
