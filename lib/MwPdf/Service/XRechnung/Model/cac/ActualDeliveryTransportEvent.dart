...
class ActualDeliveryTransportEvent {
  ...
  static ActualDeliveryTransportEvent? fromJson(Map<String, dynamic>? json) {
  ...
  static ActualDeliveryTransportEvent? fromXml(XmlElement? xml) {
