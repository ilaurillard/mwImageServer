...
class WarehousingTransportEvent {
  ...
  static WarehousingTransportEvent? fromJson(Map<String, dynamic>? json) {
  ...
  static WarehousingTransportEvent? fromXml(XmlElement? xml) {
