...
class OfficeOfDestinationLocation {
  ...
  static OfficeOfDestinationLocation? fromJson(Map<String, dynamic>? json) {
  ...
  static OfficeOfDestinationLocation? fromXml(XmlElement? xml) {
