...
class WHOAffectedAreaPortLocation {
  ...
  static WHOAffectedAreaPortLocation? fromJson(Map<String, dynamic>? json) {
  ...
  static WHOAffectedAreaPortLocation? fromXml(XmlElement? xml) {
