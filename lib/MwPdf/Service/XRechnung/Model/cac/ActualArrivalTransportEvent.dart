...
class ActualArrivalTransportEvent {
  ...
  static ActualArrivalTransportEvent? fromJson(Map<String, dynamic>? json) {
  ...
  static ActualArrivalTransportEvent? fromXml(XmlElement? xml) {
