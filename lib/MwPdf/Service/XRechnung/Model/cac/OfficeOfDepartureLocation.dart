...
class OfficeOfDepartureLocation {
  ...
  static OfficeOfDepartureLocation? fromJson(Map<String, dynamic>? json) {
  ...
  static OfficeOfDepartureLocation? fromXml(XmlElement? xml) {
