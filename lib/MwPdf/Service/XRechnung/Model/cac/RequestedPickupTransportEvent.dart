...
class RequestedPickupTransportEvent {
  ...
  static RequestedPickupTransportEvent? fromJson(Map<String, dynamic>? json) {
  ...
  static RequestedPickupTransportEvent? fromXml(XmlElement? xml) {
