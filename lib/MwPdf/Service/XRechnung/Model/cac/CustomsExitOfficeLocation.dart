...
class CustomsExitOfficeLocation {
  ...
  static CustomsExitOfficeLocation? fromJson(Map<String, dynamic>? json) {
  ...
  static CustomsExitOfficeLocation? fromXml(XmlElement? xml) {
