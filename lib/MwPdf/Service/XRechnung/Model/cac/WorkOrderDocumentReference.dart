...
class WorkOrderDocumentReference {
  ...
  static WorkOrderDocumentReference? fromJson(Map<String, dynamic>? json) {
  ...
  static WorkOrderDocumentReference? fromXml(XmlElement? xml) {
