...
class ExaminationTransportEvent {
  ...
  static ExaminationTransportEvent? fromJson(Map<String, dynamic>? json) {
  ...
  static ExaminationTransportEvent? fromXml(XmlElement? xml) {
