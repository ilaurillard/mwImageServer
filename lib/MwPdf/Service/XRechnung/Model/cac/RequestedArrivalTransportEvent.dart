...
class RequestedArrivalTransportEvent {
  ...
  static RequestedArrivalTransportEvent? fromJson(Map<String, dynamic>? json) {
  ...
  static RequestedArrivalTransportEvent? fromXml(XmlElement? xml) {
