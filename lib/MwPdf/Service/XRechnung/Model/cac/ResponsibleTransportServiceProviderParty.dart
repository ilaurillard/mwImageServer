...
class ResponsibleTransportServiceProviderParty {
  ...
  static ResponsibleTransportServiceProviderParty? fromJson(Map<String, dynamic>? json) {
  ...
  static ResponsibleTransportServiceProviderParty? fromXml(XmlElement? xml) {
