...
class ActualPickupTransportEvent {
  ...
  static ActualPickupTransportEvent? fromJson(Map<String, dynamic>? json) {
  ...
  static ActualPickupTransportEvent? fromXml(XmlElement? xml) {
