...
class AlternativeDeliveryLocation {
  ...
  static AlternativeDeliveryLocation? fromJson(Map<String, dynamic>? json) {
  ...
  static AlternativeDeliveryLocation? fromXml(XmlElement? xml) {
