...
class RequestedDepartureTransportEvent {
  ...
  static RequestedDepartureTransportEvent? fromJson(Map<String, dynamic>? json) {
  ...
  static RequestedDepartureTransportEvent? fromXml(XmlElement? xml) {
