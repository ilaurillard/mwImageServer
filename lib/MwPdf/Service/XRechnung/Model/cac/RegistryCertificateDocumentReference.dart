...
class RegistryCertificateDocumentReference {
  ...
  static RegistryCertificateDocumentReference? fromJson(Map<String, dynamic>? json) {
  ...
  static RegistryCertificateDocumentReference? fromXml(XmlElement? xml) {
