...
class UnsupportedTransportEquipment {
  ...
  static UnsupportedTransportEquipment? fromJson(Map<String, dynamic>? json) {
  ...
  static UnsupportedTransportEquipment? fromXml(XmlElement? xml) {
  ...
  XmlNode toXml() {
    ...
    List<XmlNode?> c2 = [
      uBLExtensions?.toXml(),
      iD?.toXml(),
      ...referencedConsignmentID.map((ReferencedConsignmentID e) => e.toXml()),
      ...
      ...specialTransportRequirements.map((SpecialTransportRequirements e) => e.toXml()),
      ...
      ...transportEquipmentSeal.map((TransportEquipmentSeal e) => e.toXml()),
      ...
      ...positioningTransportEvent.map((PositioningTransportEvent e) => e.toXml()),
      ...quarantineTransportEvent.map((QuarantineTransportEvent e) => e.toXml()),
      ...deliveryTransportEvent.map((DeliveryTransportEvent e) => e.toXml()),
      ...pickupTransportEvent.map((PickupTransportEvent e) => e.toXml()),
      ...handlingTransportEvent.map((HandlingTransportEvent e) => e.toXml()),
      ...loadingTransportEvent.map((LoadingTransportEvent e) => e.toXml()),
      ...transportEvent.map((TransportEvent e) => e.toXml()),
      applicableTransportMeans?.toXml(),
      ...haulageTradingTerms.map((HaulageTradingTerms e) => e.toXml()),
      ...hazardousGoodsTransit.map((HazardousGoodsTransit e) => e.toXml()),
      ...packagedTransportHandlingUnit.map((PackagedTransportHandlingUnit e) => e.toXml()),
      ...serviceAllowanceCharge.map((ServiceAllowanceCharge e) => e.toXml()),
      ...freightAllowanceCharge.map((FreightAllowanceCharge e) => e.toXml()),
      ...attachedTransportEquipment.map((AttachedTransportEquipment e) => e.toXml()),
      delivery?.toXml(),
      pickup?.toXml(),
      despatch?.toXml(),
      ...shipmentDocumentReference.map((ShipmentDocumentReference e) => e.toXml()),
      ...containedInTransportEquipment.map((ContainedInTransportEquipment e) => e.toXml()),
