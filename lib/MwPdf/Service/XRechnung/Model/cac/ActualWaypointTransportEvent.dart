...
class ActualWaypointTransportEvent {
  ...
  static ActualWaypointTransportEvent? fromJson(Map<String, dynamic>? json) {
  ...
  static ActualWaypointTransportEvent? fromXml(XmlElement? xml) {
