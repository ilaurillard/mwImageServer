...
class PlannedDeliveryTransportEvent {
  ...
  static PlannedDeliveryTransportEvent? fromJson(Map<String, dynamic>? json) {
  ...
  static PlannedDeliveryTransportEvent? fromXml(XmlElement? xml) {
