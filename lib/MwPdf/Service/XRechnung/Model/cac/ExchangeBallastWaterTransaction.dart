...
class ExchangeBallastWaterTransaction {
  ...
  static ExchangeBallastWaterTransaction? fromJson(Map<String, dynamic>? json) {
    if (json == null) { return null; }
    return ExchangeBallastWaterTransaction (
  ...
  static ExchangeBallastWaterTransaction? fromXml(XmlElement? xml) {
