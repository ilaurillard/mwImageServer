...
class ExportationTransportEvent {
  ...
  static ExportationTransportEvent? fromJson(Map<String, dynamic>? json) {
  ...
  static ExportationTransportEvent? fromXml(XmlElement? xml) {
