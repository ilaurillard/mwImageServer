...
class ApplicableDeliveryPeriod {
  ...
  static ApplicableDeliveryPeriod? fromJson(Map<String, dynamic>? json) {
  ...
  static ApplicableDeliveryPeriod? fromXml(XmlElement? xml) {
  ...
  XmlNode toXml() {
    ...
    List<XmlNode?> c2 = [
      ...
      ...descriptionCode.map((DescriptionCode e) => e.toXml()),
