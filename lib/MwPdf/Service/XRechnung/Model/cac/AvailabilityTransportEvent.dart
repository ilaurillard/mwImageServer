...
class AvailabilityTransportEvent {
  ...
  static AvailabilityTransportEvent? fromJson(Map<String, dynamic>? json) {
  ...
  static AvailabilityTransportEvent? fromXml(XmlElement? xml) {
