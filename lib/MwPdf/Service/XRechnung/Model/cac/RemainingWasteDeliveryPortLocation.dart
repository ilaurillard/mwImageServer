...
class RemainingWasteDeliveryPortLocation {
  ...
  static RemainingWasteDeliveryPortLocation? fromJson(Map<String, dynamic>? json) {
    if (json == null) { return null; }
    return RemainingWasteDeliveryPortLocation (
  ...
  static RemainingWasteDeliveryPortLocation? fromXml(XmlElement? xml) {
