...
class HazardousItemNotificationParty {
  ...
  static HazardousItemNotificationParty? fromJson(Map<String, dynamic>? json) {
  ...
  static HazardousItemNotificationParty? fromXml(XmlElement? xml) {
