...
class UptakeBallastWaterTransaction {
  ...
  static UptakeBallastWaterTransaction? fromJson(Map<String, dynamic>? json) {
    if (json == null) { return null; }
    return UptakeBallastWaterTransaction (
  ...
  static UptakeBallastWaterTransaction? fromXml(XmlElement? xml) {
