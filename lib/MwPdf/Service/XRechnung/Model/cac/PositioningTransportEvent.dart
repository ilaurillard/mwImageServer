...
class PositioningTransportEvent {
  ...
  static PositioningTransportEvent? fromJson(Map<String, dynamic>? json) {
  ...
  static PositioningTransportEvent? fromXml(XmlElement? xml) {
