...
class OfficeOfSubSequentiallyEntryLocation {
  ...
  static OfficeOfSubSequentiallyEntryLocation? fromJson(Map<String, dynamic>? json) {
  ...
  static OfficeOfSubSequentiallyEntryLocation? fromXml(XmlElement? xml) {
