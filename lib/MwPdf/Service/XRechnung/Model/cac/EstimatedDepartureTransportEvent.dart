...
class EstimatedDepartureTransportEvent {
  ...
  static EstimatedDepartureTransportEvent? fromJson(Map<String, dynamic>? json) {
  ...
  static EstimatedDepartureTransportEvent? fromXml(XmlElement? xml) {
