...
class ShipSanitationControlCertificate {
  ...
  static ShipSanitationControlCertificate? fromJson(Map<String, dynamic>? json) {
  ...
  static ShipSanitationControlCertificate? fromXml(XmlElement? xml) {
