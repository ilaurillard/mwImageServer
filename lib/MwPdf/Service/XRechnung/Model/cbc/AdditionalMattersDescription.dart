...
class AdditionalMattersDescription {
  ...
  static AdditionalMattersDescription? fromJson(Map<String, dynamic>? json) {
    if (json == null) { return null; }
    return AdditionalMattersDescription (
  ...
  static AdditionalMattersDescription? fromXml(XmlElement? xml) {
