...
class TotalBallastWaterCapacityMeasure {
  ...
  static TotalBallastWaterCapacityMeasure? fromJson(Map<String, dynamic>? json) {
  ...
  static TotalBallastWaterCapacityMeasure? fromXml(XmlElement? xml) {
