...
class EnvironmentalEmissionTypeCode {
  ...
  static EnvironmentalEmissionTypeCode? fromJson(Map<String, dynamic>? json) {
  ...
  static EnvironmentalEmissionTypeCode? fromXml(XmlElement? xml) {
