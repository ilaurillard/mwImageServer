...
class PlannedOperationsDescription {
  ...
  static PlannedOperationsDescription? fromJson(Map<String, dynamic>? json) {
    if (json == null) { return null; }
    return PlannedOperationsDescription (
  ...
  static PlannedOperationsDescription? fromXml(XmlElement? xml) {
