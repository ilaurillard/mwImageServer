...
class TanksNotExchangedQuantity {
  ...
  static TanksNotExchangedQuantity? fromJson(Map<String, dynamic>? json) {
  ...
  static TanksNotExchangedQuantity? fromXml(XmlElement? xml) {
