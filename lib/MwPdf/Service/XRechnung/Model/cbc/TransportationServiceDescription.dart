...
class TransportationServiceDescription {
  ...
  static TransportationServiceDescription? fromJson(Map<String, dynamic>? json) {
  ...
  static TransportationServiceDescription? fromXml(XmlElement? xml) {
