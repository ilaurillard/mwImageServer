...
class EstimatedGeneratedUntilNextPortMeasure {
  ...
  static EstimatedGeneratedUntilNextPortMeasure? fromJson(Map<String, dynamic>? json) {
  ...
  static EstimatedGeneratedUntilNextPortMeasure? fromXml(XmlElement? xml) {
