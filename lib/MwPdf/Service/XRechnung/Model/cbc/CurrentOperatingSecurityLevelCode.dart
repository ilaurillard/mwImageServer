...
class CurrentOperatingSecurityLevelCode {
  ...
  static CurrentOperatingSecurityLevelCode? fromJson(Map<String, dynamic>? json) {
  ...
  static CurrentOperatingSecurityLevelCode? fromXml(XmlElement? xml) {
