...
class TransportHandlingUnitTypeCode {
  ...
  static TransportHandlingUnitTypeCode? fromJson(Map<String, dynamic>? json) {
  ...
  static TransportHandlingUnitTypeCode? fromXml(XmlElement? xml) {
