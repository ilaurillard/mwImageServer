...
class PlannedWorksDescription {
  ...
  static PlannedWorksDescription? fromJson(Map<String, dynamic>? json) {
    if (json == null) { return null; }
    return PlannedWorksDescription (
  ...
  static PlannedWorksDescription? fromXml(XmlElement? xml) {
