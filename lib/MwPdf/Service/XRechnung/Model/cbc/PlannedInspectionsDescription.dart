...
class PlannedInspectionsDescription {
  ...
  static PlannedInspectionsDescription? fromJson(Map<String, dynamic>? json) {
    if (json == null) { return null; }
    return PlannedInspectionsDescription (
  ...
  static PlannedInspectionsDescription? fromXml(XmlElement? xml) {
