...
class CourseOverGroundDirection {
  ...
  static CourseOverGroundDirection? fromJson(Map<String, dynamic>? json) {
  ...
  static CourseOverGroundDirection? fromXml(XmlElement? xml) {
