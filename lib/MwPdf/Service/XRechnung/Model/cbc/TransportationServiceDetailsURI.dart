...
class TransportationServiceDetailsURI {
  ...
  static TransportationServiceDetailsURI? fromJson(Map<String, dynamic>? json) {
  ...
  static TransportationServiceDetailsURI? fromXml(XmlElement? xml) {
