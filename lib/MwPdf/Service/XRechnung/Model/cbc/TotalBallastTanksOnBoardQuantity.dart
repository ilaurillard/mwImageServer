...
class TotalBallastTanksOnBoardQuantity {
  ...
  static TotalBallastTanksOnBoardQuantity? fromJson(Map<String, dynamic>? json) {
  ...
  static TotalBallastTanksOnBoardQuantity? fromXml(XmlElement? xml) {
