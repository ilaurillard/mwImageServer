...
class NatureOfIllnessDescription {
  ...
  static NatureOfIllnessDescription? fromJson(Map<String, dynamic>? json) {
    if (json == null) { return null; }
    return NatureOfIllnessDescription (
  ...
  static NatureOfIllnessDescription? fromXml(XmlElement? xml) {
