...
class TaxInclusiveLineExtensionAmount {
  ...
  static TaxInclusiveLineExtensionAmount? fromJson(Map<String, dynamic>? json) {
  ...
  static TaxInclusiveLineExtensionAmount? fromXml(XmlElement? xml) {
