...
class WithholdingTaxTotalAmount {
  ...
  static WithholdingTaxTotalAmount? fromJson(Map<String, dynamic>? json) {
  ...
  static WithholdingTaxTotalAmount? fromXml(XmlElement? xml) {
