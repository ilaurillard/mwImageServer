...
class CompanyLiquidationStatusCode {
  ...
  static CompanyLiquidationStatusCode? fromJson(Map<String, dynamic>? json) {
  ...
  static CompanyLiquidationStatusCode? fromXml(XmlElement? xml) {
