...
class ReferencedDocumentInternalAddress {
  ...
  static ReferencedDocumentInternalAddress? fromJson(Map<String, dynamic>? json) {
  ...
  static ReferencedDocumentInternalAddress? fromXml(XmlElement? xml) {
