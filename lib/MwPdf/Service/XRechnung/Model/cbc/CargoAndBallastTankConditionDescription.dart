...
class CargoAndBallastTankConditionDescription {
  ...
  static CargoAndBallastTankConditionDescription? fromJson(Map<String, dynamic>? json) {
    if (json == null) { return null; }
    return CargoAndBallastTankConditionDescription (
  ...
  static CargoAndBallastTankConditionDescription? fromXml(XmlElement? xml) {
