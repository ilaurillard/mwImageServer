...
class PerformingCarrierAssignedID {
  ...
  static PerformingCarrierAssignedID? fromJson(Map<String, dynamic>? json) {
  ...
  static PerformingCarrierAssignedID? fromXml(XmlElement? xml) {
