...
class GivenTreatmentDescription {
  ...
  static GivenTreatmentDescription? fromJson(Map<String, dynamic>? json) {
    if (json == null) { return null; }
    return GivenTreatmentDescription (
  ...
  static GivenTreatmentDescription? fromXml(XmlElement? xml) {
