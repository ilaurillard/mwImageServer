...
class SpecialServiceInstructions {
  ...
  static SpecialServiceInstructions? fromJson(Map<String, dynamic>? json) {
  ...
  static SpecialServiceInstructions? fromXml(XmlElement? xml) {
