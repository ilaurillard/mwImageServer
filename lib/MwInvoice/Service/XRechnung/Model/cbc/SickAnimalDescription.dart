...
class SickAnimalDescription {
  ...
  static SickAnimalDescription? fromJson(Map<String, dynamic>? json) {
    if (json == null) { return null; }
    return SickAnimalDescription (
  ...
  static SickAnimalDescription? fromXml(XmlElement? xml) {
