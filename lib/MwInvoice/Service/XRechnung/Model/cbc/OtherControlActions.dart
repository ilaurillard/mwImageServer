...
class OtherControlActions {
  ...
  static OtherControlActions? fromJson(Map<String, dynamic>? json) {
    if (json == null) { return null; }
    return OtherControlActions (
  ...
  static OtherControlActions? fromXml(XmlElement? xml) {
