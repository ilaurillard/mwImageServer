...
class ContractedCarrierAssignedID {
  ...
  static ContractedCarrierAssignedID? fromJson(Map<String, dynamic>? json) {
  ...
  static ContractedCarrierAssignedID? fromXml(XmlElement? xml) {
