...
class FreightForwarderAssignedID {
  ...
  static FreightForwarderAssignedID? fromJson(Map<String, dynamic>? json) {
  ...
  static FreightForwarderAssignedID? fromXml(XmlElement? xml) {
