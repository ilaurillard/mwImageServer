...
class RequestedWaypointTransportEvent {
  ...
  static RequestedWaypointTransportEvent? fromJson(Map<String, dynamic>? json) {
  ...
  static RequestedWaypointTransportEvent? fromXml(XmlElement? xml) {
