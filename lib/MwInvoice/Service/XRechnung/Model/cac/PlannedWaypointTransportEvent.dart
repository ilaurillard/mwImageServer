...
class PlannedWaypointTransportEvent {
  ...
  static PlannedWaypointTransportEvent? fromJson(Map<String, dynamic>? json) {
  ...
  static PlannedWaypointTransportEvent? fromXml(XmlElement? xml) {
