...
class PrimaryPortCallPurpose {
  ...
  static PrimaryPortCallPurpose? fromJson(Map<String, dynamic>? json) {
  ...
  static PrimaryPortCallPurpose? fromXml(XmlElement? xml) {
  ...
  XmlNode toXml() {
    ...
    List<XmlNode?> c2 = [
      ...
      ...purposeType.map((PurposeType e) => e.toXml()),
