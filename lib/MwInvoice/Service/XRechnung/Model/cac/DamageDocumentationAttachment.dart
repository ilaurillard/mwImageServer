...
class DamageDocumentationAttachment {
  ...
  static DamageDocumentationAttachment? fromJson(Map<String, dynamic>? json) {
    if (json == null) { return null; }
    return DamageDocumentationAttachment (
  ...
  static DamageDocumentationAttachment? fromXml(XmlElement? xml) {
