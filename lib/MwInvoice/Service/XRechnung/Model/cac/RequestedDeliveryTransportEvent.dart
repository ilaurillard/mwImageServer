...
class RequestedDeliveryTransportEvent {
  ...
  static RequestedDeliveryTransportEvent? fromJson(Map<String, dynamic>? json) {
  ...
  static RequestedDeliveryTransportEvent? fromXml(XmlElement? xml) {
