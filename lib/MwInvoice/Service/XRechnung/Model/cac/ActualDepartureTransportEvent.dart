...
class ActualDepartureTransportEvent {
  ...
  static ActualDepartureTransportEvent? fromJson(Map<String, dynamic>? json) {
  ...
  static ActualDepartureTransportEvent? fromXml(XmlElement? xml) {
