...
class EstimatedArrivalTransportEvent {
  ...
  static EstimatedArrivalTransportEvent? fromJson(Map<String, dynamic>? json) {
  ...
  static EstimatedArrivalTransportEvent? fromXml(XmlElement? xml) {
