...
class AdditionalSecurityMeasure {
  ...
  static AdditionalSecurityMeasure? fromJson(Map<String, dynamic>? json) {
  ...
  static AdditionalSecurityMeasure? fromXml(XmlElement? xml) {
