...
class MainCarriageShipmentStage {
  ...
  static MainCarriageShipmentStage? fromJson(Map<String, dynamic>? json) {
  ...
  static MainCarriageShipmentStage? fromXml(XmlElement? xml) {
  ...
  XmlNode toXml() {
    ...
    List<XmlNode?> c2 = [
      ...
      ...shipmentStageType.map((ShipmentStageType e) => e.toXml()),
      ...
      ...demurrageInstructions.map((DemurrageInstructions e) => e.toXml()),
      crewQuantity?.toXml(),
      passengerQuantity?.toXml(),
      transitPeriod?.toXml(),
      ...carrierParty.map((CarrierParty e) => e.toXml()),
      ...
      ...detentionTransportEvent.map((DetentionTransportEvent e) => e.toXml()),
      requestedDepartureTransportEvent?.toXml(),
      requestedArrivalTransportEvent?.toXml(),
      ...requestedWaypointTransportEvent.map((RequestedWaypointTransportEvent e) => e.toXml()),
      plannedDepartureTransportEvent?.toXml(),
      plannedArrivalTransportEvent?.toXml(),
      ...plannedWaypointTransportEvent.map((PlannedWaypointTransportEvent e) => e.toXml()),
      ...
      ...passengerPerson.map((PassengerPerson e) => e.toXml()),
      ...driverPerson.map((DriverPerson e) => e.toXml()),
      reportingPerson?.toXml(),
      ...crewMemberPerson.map((CrewMemberPerson e) => e.toXml()),
      securityOfficerPerson?.toXml(),
      masterPerson?.toXml(),
      shipsSurgeonPerson?.toXml(),
      destinationPortCall?.toXml(),
      ...shipStoreArticle.map((ShipStoreArticle e) => e.toXml()),
      ...crewPersonEffect.map((CrewPersonEffect e) => e.toXml()),
      ...maritimeWaste.map((MaritimeWaste e) => e.toXml()),
