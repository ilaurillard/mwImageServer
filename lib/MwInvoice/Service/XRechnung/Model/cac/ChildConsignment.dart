...
class ChildConsignment {
  ...
  XmlNode toXml() {
    ...
    List<XmlNode?> c2 = [
      ...
      ...summaryDescription.map((SummaryDescription e) => e.toXml()),
      totalInvoiceAmount?.toXml(),
      declaredCustomsValueAmount?.toXml(),
      ...tariffDescription.map((TariffDescription e) => e.toXml()),
      tariffCode?.toXml(),
      ...
      ...carrierServiceInstructions.map((CarrierServiceInstructions e) => e.toXml()),
      ...customsClearanceServiceInstructions.map((CustomsClearanceServiceInstructions e) => e.toXml()),
      ...forwarderServiceInstructions.map((ForwarderServiceInstructions e) => e.toXml()),
      ...specialServiceInstructions.map((SpecialServiceInstructions e) => e.toXml()),
      sequenceID?.toXml(),
      ...
      ...haulageInstructions.map((HaulageInstructions e) => e.toXml()),
      loadingSequenceID?.toXml(),
      childConsignmentQuantity?.toXml(),
      totalPackagesQuantity?.toXml(),
      ...consolidatedShipment.map((ConsolidatedShipment e) => e.toXml()),
      ...
      ...childConsignment.map((ChildConsignment e) => e.toXml()),
      ...
      ...transitCountry.map((TransitCountry e) => e.toXml()),
      ...
      ...extraAllowanceCharge.map((ExtraAllowanceCharge e) => e.toXml()),
      ...mainCarriageShipmentStage.map((MainCarriageShipmentStage e) => e.toXml()),
      ...preCarriageShipmentStage.map((PreCarriageShipmentStage e) => e.toXml()),
      ...onCarriageShipmentStage.map((OnCarriageShipmentStage e) => e.toXml()),
