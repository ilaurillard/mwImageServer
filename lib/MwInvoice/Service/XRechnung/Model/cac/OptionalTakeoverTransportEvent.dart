...
class OptionalTakeoverTransportEvent {
  ...
  static OptionalTakeoverTransportEvent? fromJson(Map<String, dynamic>? json) {
  ...
  static OptionalTakeoverTransportEvent? fromXml(XmlElement? xml) {
